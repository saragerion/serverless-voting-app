...
export default function () {
  const response = http.get('https://serverless-voting-app-new.demo.awsara.com');
  ...
  group('Static Assets', () => {
    ...
    const resps = http.batch([
      [ 'GET', 'https://serverless-voting-app-new.demo.awsara.com/static/1664476146/css/style.css', null, { tags: { staticAsset: 'yes' } } ],
      [ 'GET', 'https://serverless-voting-app-new.demo.awsara.com/static/1664476146/js/script.js', null, { tags: { staticAsset: 'yes' } } ]
    ]);
